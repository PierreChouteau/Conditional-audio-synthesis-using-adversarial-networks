...
class NSynthDataset(Dataset):
    def __init__(self, root_dir, usage = 'train', filter_key=None, resample_rate=16000, signal_duration=4, maxi=1):
    ...
    def __getitem__(self, idx):
        ...
        melspec_log = self.waveform_to_mel(waveform, sample_rate, self.resample_rate, self.signal_duration)
